     ...
     document.oncontextmenu = function(e) {
         ...
         if (balk.style.visibility == "hidden") {
             ...
             if (bolk.value == "") {} else {
                 ...
                 posi = {
                     x: parseInt(balk.style.left, 10) / width,
                     y: parseInt(balk.style.top, 10) / height,
                     text: bolk.value,
                     w: document.getElementById("rag").value
                 };
                 socket.emit('text', {
     ...
     function mainLoop() {
         ...
         if (mouse.click && mouse.move && mouse.pos_prev) {
             ...
             socket.emit('draw_line', {
                 line: [mouse.pos, mouse.pos_prev, mouse.colour]
             });
             mouse.move = false;
             if (touch) {
                 mouse.pos_prev = {
